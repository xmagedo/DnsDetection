...
class DNSchDetector():
	...
	def read_corpus_file(self):
		uni, bi, tri, quad = pkl.load( open ("/Users/abdulmajeedalroumi/Desktop/DNS_detection/CHDictionaryCorpus.p", "rb") )
	...
	##Read in live data, clean numbers and dashes, option to filter on subdomains
	def read_clean_data(self):
		...
		for line in open(self.infile, "rU"):
			...
			# most chinese domains have these Top level domains, wouldn't have .eu or .ru
...
if __name__ == "__main__":
	    ...
	    f= open('/Users/abdulmajeedalroumi/Desktop/fileread.txt', 'w+')
	    normalized_score=0
	    count=0
	    print ('Domain', 'Score')
